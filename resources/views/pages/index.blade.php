    ...
    {{-- <div class="container">
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <p><a class="btn btn-primary btn-lg" href="/first/public/login" role="button">Login</a>
                            <a class="btn btn-success btn-lg" href="/first/public/register" role="button">Register</a>
                        </p>
                    </div>
            </div>
    </div> --}}
              ...
              <div class="row blog-entries">
                <div class="col-md-12 col-lg-8 main-content">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <a href="/first/public/posts/{{$post->id}}" class="blog-entry element-animate" data-animate-effect="fadeIn">
                        <img src="/first/storage/app/public/cover_images/{{$post->cover_image}}" alt="Image placeholder">
